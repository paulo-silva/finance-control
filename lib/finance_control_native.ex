defmodule FinanceControlNative do
  @moduledoc """
  ...
  This can be used in your application as:
      ...
      use FinanceControlNative, :live_view
  ...
  import FinanceControlWeb, only: [verified_routes: 0]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([FinanceControlWeb, CoreComponents, plugin.module_suffix])

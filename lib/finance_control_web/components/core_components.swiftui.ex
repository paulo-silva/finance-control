defmodule FinanceControlWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `FinanceControlWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FinanceControlWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FinanceControlWeb.Gettext, "errors", msg, opts)
    end
  end
